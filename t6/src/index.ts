...
console.log(`Reverse Array of Numbers: ${reverseArray<number>(numberArray)} `);
console.log(`Reverse Array of Strings: ${reverseArray<string>(stringArray)} `);
console.log(`Reverse Mixed Array: ${reverseArray(mixedArray)} `);
